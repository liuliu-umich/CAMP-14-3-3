#!/bin/bash
#SBATCH --job-name=score_st_sites_test
...
# python score_all_st_sites_from_fasta_test.py

/home/luvul/.conda/envs/1433predictor2026/bin/python score_all_st_sites_from_fasta_test.py
